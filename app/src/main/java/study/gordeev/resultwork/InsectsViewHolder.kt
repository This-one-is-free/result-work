...
class InsectsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {

    private val insectsImageView: ImageView = itemView.findViewById(R.id.item_image_view)
    ...
    fun bind(data: Data) {
        insectsImageView.setImageResource(data.image)
